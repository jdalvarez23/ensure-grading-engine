...
var testWidget = (function() {
  ...
  var innerStyles = '@font-face{' +
    ...
    sairaSemiCondFontRegular +
    ') format("truetype");' +
    '} ' +
    '@font-face{' +
    'font-family: "Saira SemiCondensed Medium";' +
    'src: url(data:font/ttf;base64,' +
    sairaSemiCondFontMedium +
    ') format("truetype");' +
    '} ' +
    '* {' +
    'font-family: "Saira SemiCondensed Regular"' +
  ...
  var template = {
    head: '    <title>Ensure Feedback Tool</title>' +
      '    <meta charset="UTF-8">' +
    ...
    body: '  <body>' +
      ...
      '    <div class="widget-header">Ensure Feedback</div>' +
      '    </div>' +
