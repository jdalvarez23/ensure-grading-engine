...
(function() {
   ...
   */
  function updateView() {
    //  console.log('UPDATEVIEW() IN ACTION');
    ...
    if (testPassed === 'true') {
      //console.log('TRUE: ' + markRightOrWrong);
      _testHasPassed(markRightOrWrong);
    } else if (testPassed === 'false') {
      // NOTE: Added this in order to manually hide the suite-code if one of the tests is marked wrong
      self.parentElement.parentElement.getElementsByClassName('suite-code-container')[0].style.display = 'none';
      self.parentElement.parentElement.getElementsByClassName('suite-name')[0].textContent = '';
      self.parentElement.parentElement.getElementsByClassName('suite-code')[0].textContent = '';
      //console.log(self);
