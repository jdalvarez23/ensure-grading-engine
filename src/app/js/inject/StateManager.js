...
function StateManager() {
    ...
    if (!currentlyInjecting || self.geInjected) {
      ...
      return importComponentsLibrary()
        ...
        .then(function() {
          ...
          // debugger;
          console.log(e);
          throw new Error('Something went wrong loading Mr.Hayes Feedback Tool. Please reload.');
        });
    } else {
      return Promise.resolve();
    }
  ...
  this.turnOff = function() {
    ...
    return injectIntoDocument('script', {
        ...
        innerHTML: 'ensureFEGradingEngine.turnOff();' +
          'delete window.ensureFEGradingEngine;' +
          'window.addEventListener("killensureFEGradingEngine", function handler() {' +
          '  window.removeEventListener("killensureFEGradingEngine", handler, false);' +
      ...
      .then(function() {
        return new Promise(function(resolve, reject) {
          ...
          window.dispatchEvent(new Event('killensureFEGradingEngine'));
        });
      })
      .then(function() {
