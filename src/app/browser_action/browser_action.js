  ...
  sendDataToTab(true, 'background-wake', function(response) {
    switch (response) {
      ...
      case 'chrome_local_exception':
        addWarning('Chrome doesn’t support loading local files automatically', 'checkbox', {
          enableCheckbox: false,
          checked: false
        });
        break;
      case 'unknown_protocol':
        addWarning('Unsupported protocol. Supported protocols are: http, https and (local) file', 'checkbox', {
          enableCheckbox: false,
          checked: false
        });
        break;
      case 'invalid_origin':
        addWarning('The linked JSON page isn’t at the same origin and directory as the document', 'checkbox', {
          enableCheckbox: false,
          checked: false
        });
        break;
      case undefined:
        ...
        addWarning('Unsupported URL scheme. Supported URL schemes are: http://, https://, or file://. Please refresh the page.', 'disable', {});
        break;
      default:
        break;
    }
