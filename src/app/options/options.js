...
function chromiumInit() {
  if (isChromium) {
    var localPlaceholder = document.querySelector('#local-whitelist .whitelist-message');
    localPlaceholder.innerHTML = 'Google Chrome does not support loading local files asynchronously. You must manually load the test file.';
...
$(document).ready(function() {
  $('.click').on("click", function(e) {
    ...
    removeActiveNavBarClass();
    $('#' + id).addClass("active");
    $('#' + id + '_Section').fadeIn();
  });
});

function removeActiveNavBarClass() {
